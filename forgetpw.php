...
<div id="dialog" title="Password sent"> 
<p><span class="ui-icon ui-icon-info" style="float:left; margin:0 7px 0 0;"></span> Your password reset instruction has been e-mailed to you. Press ok button to continue. 
</p> 
   ...
   <div class="widget widget-list well">
	  ...
	  <div class="span9">
	   <div class="separator">	  </div><!-- separator -->
		...
		<div style="margin-left: 10px;" ><font style="color:gray">Please enter the email address associated with your account. we will send you password reset instruction in the email.<font></div><br>
		<div id="errorMessage" class="error"></div>
		
        <form id="login-form" name="login-form"  method="get">
		    <label for="username">E-mail address</label>
            <input type="email" name="email" id="email" class="txt_field" tabindex="1" required autocomplete="off" autofocus>
...
function validLogin(){
     ...
     var email=$.trim($('#email').val());
	  ...
	  if(!validateEmail(email)){ // Check the username values is empty or not
