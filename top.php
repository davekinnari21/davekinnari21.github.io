    ...
    ================================================== -->
     <div class="row">
      <div class="span3 logo">
        <a href="index.php"><img src="img/bigmathlogo2.png" alt="BigMathBook.com" /></a>
      </div><!-- logo -->
		<div class="nav span9">
		...
		<nav id="nav-wrap">
          <ul id="nav" class="sf-menu">
            <li class="active"><a href="index.php">Home</a> </li>
				 <?php 
		 if(isset($_SESSION['NAME']) && !empty($_SESSION['USER'])){ 
			echo "<li> <a href='allworksheet.php'>Worksheets</a></li>";
		 }else{
			echo "<li><a href='worksheetsample.php'>Worksheets</a> </li>";
		 }?>
     ...
     <div class="span3 clearfix ">
	  ...
	  <!-- <div class="alert alert-default" onclick="window.location='gradeindex.php?cat=6';">
	   ...
	   <?php
		...
		?>
	  <a href="worksheetsample.php"><img src="img/worksheet1.png" onmouseover="this.src='img/worksheet2.png'" onmouseout="this.src='img/worksheet1.png'"></a>
	   <?php } ?>
	   </div>
	  </div>
      </div><!-- span3 -->
